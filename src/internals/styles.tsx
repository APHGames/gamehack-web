...
import kframe from '../../static/img/global/kframe.png';
...
export const Section = styled.section<{
	...
	& + section {
		border-top: 2px dashed ${colors.azureLight};
	}
`;
...
const KFrameWrapper = styled.div`
	border: 20px solid transparent;
	padding-right: 20px;
	border-image-slice: 220 fill;
	...
	border-image-outset: 0px 0px 0px 0px;
	border-image-repeat: repeat repeat;
	border-image-source: url(${kframe});
	width: min(800px, 100%);
	background-color: ${(p) => p.$color ?? colors.azureLight};
	border-image-outset: 20px;
`;

const KFrameStyled = styled(Card)`
	background-color: unset;
	width: unset;
