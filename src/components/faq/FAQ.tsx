		...
		<S.SectionContainer>
			...
			<S.Vertical>
				...
				<S.Frame $width={'820px'}>
					...
					<p>Jakékoliv, pokud budou splněny podmínky v pravidlech ohledně spuštění na platformě Windows.</p>
				</S.Frame>
				<S.Frame $width={'820px'}>
					<h4>Můžu hru z důvodu punkového nadšenectví vytvářet např. v DOSu či pro Commodore 64?</h4>
					<p>Pokud je hra vytvářená pro platformu, která není kompatibilní s MS Windows, ale existuje pro ni zdarma dostupný a snadno instalovatelný emulátor, je možné zvolit i tento postup. Doporučili bychom ale takový případ konzultovat s organizátory.</p>
				</S.Frame>
				<S.Frame $width={'820px'}>
