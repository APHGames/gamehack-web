...
const URL_CS = 'https://gamehack.aphgames.cz';
// not supported yet!
const URL_EN = 'https://gamehack.aphgames.io';
...
const customFields = {
	...
	description: 'GameJam na Fakultě informačních technologií ČVUT',
	url,
	currentLocale,
}
		...
		navbar: {
			...
			items: [
				...
				},
				{
					...
					position: 'right',
					href: 'https://discord.gg/G5MbV8Ex77',	}
				/*{
					label: isLocaleCS ?  '🇬🇧' : '🇨🇿',
